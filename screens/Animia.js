...
const Animia = () => {
  ...
  const sendData = () => {
    ...
    console.log(x);
    setData(false);
    fetch("https://carexserver.herokuapp.com/animia_predict", {
      method: "post",
      headers: {
          ...
          {data ? (
            <>
              <KeyboardAvoidingView behavior="position" enabled={shift}>
                ...
                >
                  <Text style={{ fontSize: 15 }}>Chronic Disease</Text>
                  <View
                    style={{
                      flexDirection: "row",
                    }}
              ...
              {prediction ? (
                ...
                >
                  ...
                  <Text style={{ fontSize: 17 }}>
                    ...
                    of Anemia , Please Contact your doctor.
                  </Text>
                  <Button
                    mode="contained"
                    icon="reload"
